...
<body style="background-color:#23651d">
  ...
  <div class="container">
    <div class="row d-flex justify-content-center">
      <div class="col-12 h-100 py-4" style="max-width: 700px;
        position: relative;
          background: rgba(248, 248, 248, 0.2);
            ...
            <div class="d-flex justify-content-evenly">
              <img width="150px" height="150px" src="docs/user.png" class="rounded-circle my-auto" alt="user" style="object-fit: cover; object-position:center top;">
